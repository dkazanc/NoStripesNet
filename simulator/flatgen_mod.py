...
def synth_flats_mod(projData3D_clean, source_intensity, variations_number = 3, arguments_Bessel=(1,25), specklesize = 2, kbar = 2, sigmasmooth = 2, jitter_projections = 0.0, flatsnum=20):
    """
