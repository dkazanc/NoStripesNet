...
def get_data(mode, data, chunk_size, chunk_num, hdf_idx, **kwargs):
    ...
    Parameters:
        mode : str
            Mode to process the data in. Must be one of 'raw', 'paired', or
            'dynamic'.
        data : np.ndarray
            The data to process.
        chunk_size : int
        ...
        hdf_idx : int
            ...
            mode == `paired` and number of shifts is greater than 1.
        kwargs:
...
def save_chunk(chunk, root, mode, start=0, sample_no=0, shift_no=0):
    ...
    Parameters:
        ...
        mode : str
            ...
            Must be one of ['raw', 'paired', 'dynamic'].
        start : int
...
def generate_real_data(root, hdf_file, mode, chunk_size, sample_no, no_shifts,
    ...
    Parameters:
        ...
        mode : str
            Type of data to generate. Must be one of 'raw', 'paired', or
            'dynamic'.
        chunk_size : int
