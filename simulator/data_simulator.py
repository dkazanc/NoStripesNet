...
(Objfoam3D, myObjects) = foam3D(x0min, x0max, y0min, y0max, z0min, z0max, c0min, c0max, ab_min, ab_max, N_size, tot_objects, object_type = 'ellipsoid')
...
# TODO: Save this result as this is your data WITHOUT stripes (clean data)
...
for i in range(0,shifted_positions_no):
    ...
    #TODO: you just need to save the result of the normalised data into tiffs 
